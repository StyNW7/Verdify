...
export function QuietEmptyState({
  ...
  return (
    ...
    >
      ...
      <p
        className="theme-display mt-3 max-w-[32ch]"
        style={{
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-4">
        ...
        <span className="theme-mono-sm flex items-center gap-2" style={{ color: 'var(--theme-accent)' }}>
          <Orbit size={12} />
      ...
      <div className="mt-4 flex items-end gap-3">
        <span
          ...
          style={{ fontSize: 'clamp(2.2rem, 4vw, 3.1rem)', color: 'var(--theme-fg)' }}
        >
          {routeName}
        </span>
        <span className="theme-italic pb-2" style={{ color: 'var(--theme-fg-muted)' }}>
          is being prepared
        </span>
      </div>

      <p className="mt-4 max-w-[42ch] text-[0.95rem] leading-relaxed" style={{ color: 'var(--theme-fg-muted)' }}>
        Comparing time, carbon, and cost across the corridor now so the results can expand in place instead of replacing the page.
      </p>

      <div className="mt-6 h-[3px] w-full overflow-hidden rounded-full" style={{ background: 'var(--theme-border)' }}>
        <motion.div
          initial={{ x: '-35%' }}
          animate={{ x: '115%' }}
  ...
  return (
    ...
    >
      <div className="theme-card p-6 md:p-8 lg:p-10">
        ...
        <p
          className="theme-display mt-4 max-w-[20ch]"
          style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', color: 'var(--theme-fg)' }}
        >
      ...
      >
        ...
        <div className="relative">
          ...
          <p
            className="theme-display mt-4 max-w-[16ch]"
            style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', color: 'var(--theme-fg)' }}
          >
            Carbon, savings, and points are being composed.
          </p>
          <p className="mt-4 flex items-center gap-2 text-[0.9rem]" style={{ color: 'var(--theme-fg-muted)' }}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="theme-display mt-4 max-w-[18ch]"
          style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', color: 'var(--theme-fg)' }}
        >
      ...
      >
        ...
        <div className="relative">
          ...
          <p
            className="theme-display mt-4 max-w-[15ch]"
            style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', color: 'var(--theme-fg)' }}
          >
