  ...
  return (
    <span
      ...
      style={{
        ...
        boxShadow: ring
          ? `0 0 0 2px ${ring}, 0 0 0 3px var(--landing-bg)`
    ...
    >
      <span
        ...
        style={{
          background: 'color-mix(in srgb, var(--landing-bg) 35%, transparent)',
    ...
    <span
      ...
      style={{
        background: isUp
          ...
          : 'color-mix(in srgb, var(--landing-accent-warm) 14%, transparent)',
        color: isUp ? 'var(--landing-accent)' : 'var(--landing-accent-warm)',
      }}
    >
        ...
        return (
          <button
            ...
            style={{
              ...
              background: active ? 'var(--landing-accent-soft)' : 'var(--landing-surface-alt)',
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-3">
            ...
            <span
              ...
              style={{ color: 'var(--landing-text-dim)', letterSpacing: '0.24em' }}
            >
          ...
          <div className="max-w-2xl">
            <h1
              className="landing-display text-[clamp(2.4rem,5vw,3.8rem)] leading-[1.02] tracking-[-0.035em]"
...
function MeBadge({ me }: { me: Player }) {
  return (
    ...
    >
      <Avatar player={me} size={32} ring="var(--landing-accent)" />
      <div className="flex flex-col leading-tight">
        <span className="landing-mono-sm" style={{ color: 'var(--landing-text-dim)' }}>
          YOU · #{me.rank}
        </span>
        <span className="text-[0.88rem] font-medium" style={{ color: 'var(--landing-text)' }}>
          {fmt(me.points)} pts
        </span>
      </div>
...
function Podium({ top3 }: { top3: Player[] }) {
  ...
  return (
    <div
      className="landing-card relative overflow-hidden rounded-[28px] px-6 pb-10 pt-8 lg:px-12"
    ...
    >
      <div
        ...
        style={{
          background:
            'radial-gradient(60% 45% at 50% 0%, color-mix(in srgb, var(--landing-accent) 18%, transparent), transparent 70%)',
        }}
      />
      <div className="relative flex flex-col items-center">
        <span
          className="landing-mono-sm"
          style={{ color: 'var(--landing-text-dim)', letterSpacing: '0.28em' }}
        >
          THE TOP THREE
        </span>
        <h2
  ...
  return (
    ...
    >
      <div className="relative mb-4 flex flex-col items-center">
        ...
        <p className="landing-mono-sm mt-0.5" style={{ color: 'var(--landing-text-dim)' }}>
          @{player.handle}
        </p>
        <p
          className="landing-number mt-2 text-[clamp(1.2rem,2vw,1.6rem)] tracking-[-0.03em]"
      ...
      <div
        ...
        style={{
          ...
          background:
            place === 1
              ? 'linear-gradient(180deg, color-mix(in srgb, var(--landing-accent) 28%, transparent) 0%, color-mix(in srgb, var(--landing-accent) 6%, transparent) 100%)'
              : place === 2
                ? 'linear-gradient(180deg, color-mix(in srgb, var(--landing-accent-warm) 18%, transparent) 0%, color-mix(in srgb, var(--landing-accent-warm) 4%, transparent) 100%)'
                : 'linear-gradient(180deg, color-mix(in srgb, var(--landing-text) 10%, transparent) 0%, transparent 100%)',
        }}
      >
        <div
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          'linear-gradient(135deg, color-mix(in srgb, var(--landing-accent) 16%, transparent) 0%, var(--landing-surface) 70%)',
      }}
    >
      <div
        aria-hidden
        className="pointer-events-none absolute -right-16 -top-16 h-52 w-52 rounded-full"
        style={{ background: 'var(--landing-accent-soft)', filter: 'blur(50px)' }}
      />
      <div className="relative flex flex-col items-start justify-between gap-5 px-6 py-5 sm:flex-row sm:items-center">
        <div className="flex items-center gap-4">
          <Avatar player={me} size={56} ring="var(--landing-accent)" />
          <div>
            <span
              className="landing-mono-sm"
              style={{ color: 'var(--landing-accent)', letterSpacing: '0.22em' }}
            >
              YOUR STANDING
            </span>
            <p className="text-[1.1rem] font-medium" style={{ color: 'var(--landing-text)' }}>
              Sarah Rashid{' '}
              <span style={{ color: 'var(--landing-text-dim)' }}>· @{me.handle}</span>
            </p>
            <p className="mt-1 text-[0.85rem]" style={{ color: 'var(--landing-text-muted)' }}>
              Climb <span style={{ color: 'var(--landing-accent)' }}>4 spots</span> this week to
              break the top 40.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-6">
          <div className="text-right">
            ...
            <p
              className="landing-number text-[2.2rem] tracking-[-0.03em]"
              style={{ fontWeight: 500 }}
            >
              #{me.rank}
            </p>
          </div>
          <div className="h-12 w-px" style={{ background: 'var(--landing-border)' }} />
          <div className="text-right">
            <span className="landing-mono-sm" style={{ color: 'var(--landing-text-dim)' }}>
              POINTS
            </span>
...
function Ledger({ players, me }: { players: Player[]; me: Player }) {
  ...
  return (
    <div
      className="landing-card relative overflow-hidden rounded-[24px]"
      style={{ borderColor: 'var(--landing-border)' }}
    >
      <div
      ...
      >
        <span
          className="landing-mono-sm"
          style={{ color: 'var(--landing-text-dim)', letterSpacing: '0.2em' }}
        >
...
function LedgerRow({
  ...
  return (
    <motion.li
      ...
      className="relative flex items-center justify-between gap-4 border-b px-6 py-3 last:border-b-0 transition-colors hover:bg-[var(--landing-surface-alt)]"
      style={{
        borderColor: 'var(--landing-border)',
        background: isMe
          ? 'linear-gradient(90deg, color-mix(in srgb, var(--landing-accent) 10%, transparent) 0%, transparent 70%)'
          : undefined,
      }}
    >
      {isMe && (
      ...
      <div className="flex min-w-0 items-center gap-4">
        <span
          className="landing-mono-sm w-10 shrink-0"
          style={{
            color: isMe ? 'var(--landing-accent)' : 'var(--landing-text-dim)',
        ...
        <Avatar
          player={player}
          size={34}
          ring={isMe ? 'var(--landing-accent)' : undefined}
        />
        <div className="min-w-0">
          ...
          >
            ...
            {isMe && (
              <span
                className="landing-mono-sm rounded-full border px-1.5 py-[1px]"
                style={{
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <span className="landing-mono-sm">{player.streak}d</span>
        </span>
  ...
  return (
    <motion.li
      ...
      style={{
        borderColor: 'var(--landing-border)',
        background:
          'repeating-linear-gradient(90deg, transparent 0 8px, color-mix(in srgb, var(--landing-text) 4%, transparent) 8px 9px)',
      }}
    >
      <MoreHorizontal
        className="h-4 w-4"
